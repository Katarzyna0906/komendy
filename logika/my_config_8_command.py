...
class Config(object):
    def __init__(self):
        ...
        self.state[7] = [8, 9, 0, 7, 7, 7, 7, 7]
	self.state[8] = [8, 8, 8, 8, 8, 8, 8, 7]
	self.state[9] = [9, 9, 9, 9, 9, 9, 9, 7]
       ...
       # Letters definition for every state. Normally for every state it should be a collection of strings.
        ...
        self.letters[0] = [u"ggg B C\nD E F",u"G H I\nJ K L",u"M N O\nP R S",u"T U W\nX Y Z",u"Ą Ę Ł\nŃ Ó Ś", u"_,.;?!", u"Komendy", u"KONIEC "]
        ...
        self.letters[7] = [u"Rozmowa",u"Potrzeby", u"back", u"", "", "", "", ""]
	self.letters[8] = [u"Hej, co słychać?", "fraza2", "fraza3", "fraza4", "fraza5", "fraza6", "fraza7", u"Powrót"]
	self.letters[9] = [u"Daj mi serki, proszę", "potrzeba2", "potrzeba3", "potrzeba4", "potrzba5", "potrzba6", "potrzba7", u"Powrót"]
	...
	self.actions[8] = ["choose_command('Hej, co s?')", "choose_command('')", "choose_command('')", "choose_command('')", "choose_command('')", "choose_command('')", "choose_command('')", ""]
	self.actions[9] = ["choose_command('')", "choose_command('')", "choose_command('')", "choose_command('')", "choose_command('')", "choose_command('')", "choose_command('')", ""]#'resources/plikmp3'
